...
* Run `poetry run dev` in the root directory
* Go to ChatGPT and GPT-4 > Plugins > Plugin store > Develop your own plugin and enter the local server URL (!!! **TRY WITH CAUTION**, COSTS WILL BE INCURRED.)
